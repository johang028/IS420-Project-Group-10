...
1) First, check if the customer ID is valid. If not, print a message saying invalid customer ID. 
2) Check if the restaurant ID is valid. If not, print a message saying invalid restaurant ID. 
3) If both are valid, insert a row into the review table with the input customer id, restaurant ID, review date, score and comment. 
